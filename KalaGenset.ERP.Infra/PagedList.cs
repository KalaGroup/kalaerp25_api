...
/// <summary>
/// Initializes a new instance of the <see cref="PagedList{T}" /> cla
/// </summary>
...
/// Gets the index from.
/// </summary>
/// <value>The index from.</value> 9 references | 0 changes |0 authors, 0 changes
...
/// <summary>
/// Initializes a new instance of the <see cref="PagedList{TSource, TRes
/// </summary>
/// <param name="source">The source.</param>
/// <param name="converter">The converter.</param>
/// <param name="pageIndex">The index of the page.</param>
/// <param name="pageSize">The size of the page.</param> /// <param name="indexFrom">The index from.</param>
...
if (indexFrom > pageIndex)
{
    throw new ArgumentException($"indexFrom: [indexFron) > pageIndex: [pageIndex), must indexFrom <= pageIndex");
}
...
/// <param name="source">The source.</param> name="converter">The converter.</param>
...
/// <summary>
/// Provides some help methods for <see cref="IPagedList{T}"/> interface_
/// </summary>
public static class PagedList
{
    ...
    /// <returns>An empty instance of <see cref="PagedList{T}"/>.</retur O references 10 changes 10 authors, 0 changes
